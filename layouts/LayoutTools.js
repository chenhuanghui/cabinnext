                                    ...
                                    <ul  className="grid grid--layout-mode grid--equal-height">
                                        ...
                                        <li  className="grid__item grid__item--tablet-up-third tools-grid-item">
                                            <div  className="block tools-block text-center gutter-bottom--reset ">
                                                ...
                                                <h3  className="block__heading heading--4">Hiểu rõ mã ưu đãi DELIVERY</h3>
                                                <p  className="block__content hide--mobile">Tính các thông số tài chính theo các chương trình từ đối tác delivery.</p>
                                                <p  className="block__cta"><Link href="/tools/promotion"><a>Khám phá</a></Link>
                                                </p>
                                            </div>
                                        </li>
