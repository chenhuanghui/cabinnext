        ...
        return (
            <div className="layout">
                <Head>
                    ...
                    {data && data.sec1_image && data.sec1_image[0].url ? <meta  property="og:image" content={data && data.sec1_image ? data.sec1_image[0].url : ""} /> : ''}
                                ...
                                <div className="_aov0j6">
                                    ...
                                    <div className="_kbiv5c">
                                        ...
                                        { data && data.station2_data && data.station2_data.map((p, index) => {
                                            return data.station2_data_is_available[index] === true
                                            ?
                                                <Link href='/stations/[stationID]' as={`/stations/${data.station2_data_stationID[index]}`} key = {p.toString()}>
                                                    <div className="_1xizdrk">
                                                        <div className="_1xl0u0x" role="presentation">
                                                            <div className="_6lth7f">
                                                                <div className="_6i8igo">
